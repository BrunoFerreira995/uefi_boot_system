...
constexpr EFI_GUID EFI_DEVICE_PATH_PROTOCOL_GUID = {0x09576e91, 0x433b, 0x11d3, {0xba, 0x33, 0x00, 0x80, 0x7c, 0x3c, 0x88, 0x81}};
constexpr EFI_GUID EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_GUID = {0x964e5b22, 0x6459, 0x11d2, {0x8e, 0x39, 0x00, 0xa0, 0xc9, 0x69, 0x72, 0x3b}};
constexpr EFI_GUID EFI_FILE_INFO_GUID = {0x09576e92, 0x433b, 0x11d3, {0xba, 0x33, 0x00, 0x80, 0xc7, 0x3c, 0x88, 0x81}};
constexpr EFI_GUID EFI_GRAPHICS_OUTPUT_PROTOCOL_GUID = {0x9042a9de, 0x23dc, 0x4a38, {0x96, 0xfb, 0x7d, 0xe0, 0x83, 0xc9, 0xcd, 0x41}};
